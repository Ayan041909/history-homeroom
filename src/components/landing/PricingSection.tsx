...
const PLANS = [
  {
    ...
    features: [
      "10 free lessons with built-in quizzes",
      "Historical events timeline",
      "3 free downloadable study guides",
      "Progress dashboard",
  ...
  },
  {
    ...
    description: "Unlock the full library with live tutoring sessions.",
    features: [
      "Everything in Free",
      "Full lesson library (200+ lessons)",
      "Group Tutoring sessions",
      "1-on-1 Tutoring sessions",
      "Peer Workshop access",
      "All study guides unlocked",
      "Badges & achievements",
  ...
  },
  {
    ...
    description: "The ultimate experience with exclusive content and priority access.",
    features: [
      "Everything in Plus",
      "10 exclusive Premium-only lessons",
